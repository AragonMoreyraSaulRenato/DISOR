...
<%@page import="jwapahorcado.model.Usuario"%>
...
<%
    ...
    List<Usuario> usuarios = d.getUsuariosDesc();
%>
<!DOCTYPE html>
<html>
    <head>
            ...
            <tbody>
                <% for(int i=0; i<usuarios.size(); i++){%>
                    <tr>
                        ...
                        <td><%out.print(usuarios.get(i).getGanados());%></td>
                        <td><%out.print(usuarios.get(i).getPerdidos());%></td>
                        <td><%out.print(usuarios.get(i).getRacha());%></td>
                    </tr>
                <%}%>
            </tbody>
        </table>
