    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(palabra.equals(palabraOculta)){
                ...
                PalabraJpaController palabracoontroller = new PalabraJpaController(utx, emf);
                Jugadas u = new Jugadas();
                u.setJugador(usuario);
                u.setGano("SI");
                Palabra p = palabracoontroller.getPalabraByName(palabra);
                if(p==null) System.out.println("NO ENCUENTRA LA PALABRA");
