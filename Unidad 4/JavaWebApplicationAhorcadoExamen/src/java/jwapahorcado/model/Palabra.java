...
public class Palabra implements Serializable {
    ...
    private Collection<Jugadas> jugadasCollection;
    ...
    @XmlTransient
    public Collection<Jugadas> getJugadasCollection() {
        return jugadasCollection;
    }

    public void setJugadasCollection(Collection<Jugadas> jugadasCollection) {
        this.jugadasCollection = jugadasCollection;
    }
